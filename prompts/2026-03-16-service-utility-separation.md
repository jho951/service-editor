...
- 구현 변경: `TextNormalizer`, `DocumentSortKeyGenerator`, `DocumentJsonCodec`를 별도 클래스로 두고 `WorkspaceServiceImpl`, `DocumentServiceImpl`, `DocumentApiMapper`가 이를 사용하도록 정리했다.

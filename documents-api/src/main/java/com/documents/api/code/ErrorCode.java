...
public enum ErrorCode {
    ...
    FORBIDDEN(HttpStatus.FORBIDDEN, false, 9003, "요청을 수행할 권한이 없습니다."),
    ...
    ATTACHMENT_NOT_FOUND(HttpStatus.NOT_FOUND, false, 9008, "요청한 첨부파일을 찾을 수 없습니다."),
    DOCUMENT_SNAPSHOT_NOT_FOUND(HttpStatus.NOT_FOUND, false, 9009, "요청한 문서 스냅샷을 찾을 수 없습니다."),

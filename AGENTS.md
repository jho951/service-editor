...
- 문서의 공통 흐름, 중복 제거, 외부 자료 표기 원칙은 [docs/README.md](https://github.com/jho951/Block-server/blob/dev/docs/README.md)를 기준으로 따른다.
...
- 문서도 코드와 같은 기준으로 다룬다. 처음 읽는 사람이 앞에서 제기한 문제를 뒤에서 자연스럽게 회수할 수 있어야 하며, 관련된 설명은 한 흐름 안에 묶고 문맥 점프를 최소화한다.

...
- 실행 모듈은 `platform-runtime-bom` `3.0.0`과 `platform-governance` `3.0.0`, `platform-security` `3.0.0`, `platform-resource` `3.0.0` 조합을 기준으로 적용한다.
...
- `platform-security-governance-bridge`와 `platform-resource-governance-bridge`는 `3.0.0` release train 기준으로 관리한다.
